      ...
      <div class="bg-white rounded-3xl max-w-xl w-full p-5 sm:p-6 shadow-2xl border border-pink-100 max-h-[92vh] flex flex-col animate-in fade-in zoom-in-95 duration-200">
        ...
        <div class="flex items-center justify-between border-b border-gray-100 pb-3.5 mb-4">
          <div class="flex items-center gap-2.5">
            <div class="w-10 h-10 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-600 text-white flex items-center justify-center text-xl shadow-md shadow-pink-200">
              🧾
            </div>
            <div>
              <h3 class="font-bold text-gray-900 text-base">Escanear Boleta o Factura</h3>
              <p class="text-xs text-gray-400">Actualiza precios o crea nuevos insumos automáticamente</p>
            </div>
          </div>
